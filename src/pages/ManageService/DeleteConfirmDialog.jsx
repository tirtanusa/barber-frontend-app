...
const DeleteConfirmDialog = ({ isOpen, onClose, onConfirm, serviceName }) => {
      ...
      <div className="bg-white border-2 border-black w-full max-w-md shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
        ...
        <div className="p-6">
          <p className="font-mono text-sm text-black mb-2">
            Are you sure you want to delete <span className="font-bold">"{serviceName}"</span>?
          </p>
          <p className="font-mono text-xs text-black/60">
            Note: This action will softly delete the service, so any existing bookings tied to this service will not be affected.
          </p>
